            ...
            {visibleNavLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`relative whitespace-nowrap rounded-md px-3 py-2 text-[13.5px] font-medium transition-all duration-150 ${active
              ...
              <div className="flex items-center gap-3">
                <div className="relative" ref={dropdownRef}>
                  <button
                    ...
                    className={`relative flex h-9 w-9 items-center justify-center rounded-lg transition-all ${showNotifications
                          ...
                          <div className="flex flex-col gap-1">
                            {notifications.map((n) => (
                              <Link
                                ...
                                className={`group flex flex-col gap-1.5 rounded-xl p-3 text-left transition-all ${!n.is_read ? "bg-primary-50/40" : "hover:bg-slate-50"
                                  }`}
                              >
          ...
          <div className="mt-6 flex flex-col gap-4 border-t border-slate-100 pt-6">
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className={`rounded-lg border px-4 py-2.5 text-sm font-semibold transition-all ${lang === "en" ? "bg-primary-50 border-primary-200 text-primary-700" : "border-slate-200 text-slate-600"
                  }`}
              >
                🇬🇧 English
              </button>
              <button
                ...
                className={`rounded-lg border px-4 py-2.5 text-sm font-semibold transition-all ${lang === "my" ? "bg-primary-50 border-primary-200 text-primary-700" : "border-slate-200 text-slate-600"
                  }`}
              >
                🇲🇲 မြန်မာ
              </button>
